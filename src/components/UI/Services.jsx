...
const Services = () => {
  return (
    ...
    <p className="lg: max-w-[600px] lg:mx-auto Otext-headingColor font-[500] text-[16px] leading-7 ">
...
<p className="text-[15px] text-small TextColor group-hover: text-white group-hover: for
[500] leading-7"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur, ad quas
excepturi eius optio voluptatum.</p>
</div>
</div>
</div>
...
<div className="flex justify-end w-full mx-auto items-center">
<div className="w-full sm:w-1/2 sm: pr-8">
<div data-aos='fade-left' data-aos-duration='1500' className="bg-white p-4 rounded
shadow group hover:bg-primaryColor cursor-pointer ease-in duration-150">
<h3 className="text-primaryColor font-[700] mb-3 group-hover:text-white
